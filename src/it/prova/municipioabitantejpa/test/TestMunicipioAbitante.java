...
//			
//			testPersoneMaggiorenni(municipioService);
//			System.out.println(
//					"In tabella Municipio ci sono " + municipioService.listAllMunicipi().size() + " elementi.");
//			findAllByInizialeDescrizione(municipioService);
//			System.out.println(
//					"In tabella Municipio ci sono " + municipioService.listAllMunicipi().size() + " elementi.");
//			findAllByCognome(abitanteService);
//			System.out.println(
//					"In tabella Municipio ci sono " + municipioService.listAllMunicipi().size() + " elementi.");
			testFindAllByCodiceMunicipioIniziaCon(abitanteService);
			System.out.println(
					"In tabella Municipio ci sono " + municipioService.listAllMunicipi().size() + " elementi.");
	...
	private static void testPersoneMaggiorenni(MunicipioService municipioService) throws Exception {
	...
	private static void findAllByInizialeDescrizione(MunicipioService municipioService) throws Exception {
		String descrizione = "M";
		List<Municipio> desccrizioneIniziale = municipioService.cercaMunicipioConStessaIniziale(descrizione);
		System.out.println(desccrizioneIniziale);
		System.out.println("PASSED");

	}

	private static void findAllByCognome(AbitanteService abitanteService) throws Exception {
		String cognome = "prova";
		List<Abitante> result = abitanteService.cercaTuttiGliAbitantiConCognome(cognome);
		if (result.size() < 1)
			throw new RuntimeException("errore");
		System.out.println(result);
		System.out.println("PASSED");
	}
	private static void testFindAllByCodiceMunicipioIniziaCon(AbitanteService abitanteService) throws Exception {
		String codice="III";
		List<Abitante> result=abitanteService.cercaMunicipioConCodice(codice);
		System.out.println(result);
		System.out.println("PASSED");
	}
